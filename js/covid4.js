...
var tip = d3.tip().attr('class', 'd3-tip')
    .html(function(d) {
       ...
       text += "<strong>Cases:</strong> <span style='color:red'>" + d3.format(",.0f")(d.new_cases) + "</span><br>";
       return text;
    });
g.call(tip);
...
g.append("text")
    ...
    .text("New Cases Per Day in the United States");
...
g.append("text")
    ...
    .text("Number of New Cases (log base 10)");
...
d3.csv("data/jd_us_cases_and_deaths.csv").then(function(data){
    ...
    var y = d3.scaleLog().clamp(true)
        .domain([1, d3.max(data, function(d) { return d.new_cases })])
        .range([height, 0])
        .base(10);
